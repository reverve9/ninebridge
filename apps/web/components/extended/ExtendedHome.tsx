  ...
  return (
    <div className="fixed top-0 left-[530px] w-[750px] h-screen flex items-center">
      ...
      <div className="flex items-center gap-3">
        {/* 문의하기 버튼 */}
        <button className="flex items-center gap-2 px-6 py-3 border border-[#ddd] bg-white text-[#333] text-[15px] font-medium rounded-[4px] hover:bg-[#f9f9f9] transition-colors">
          ...
          <>
            {settings.sns_kakao && (
              <a 
                ...
                className="flex items-center gap-2 px-5 py-3 border border-[#ddd] bg-white text-[#333] text-[15px] font-medium rounded-[4px] hover:bg-[#f9f9f9] transition-colors"
              >
